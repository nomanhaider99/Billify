...
const Hero = () => {
  ...
  return (
    <div className='w-full md:pl-10 pl-4 md:py-[3vw] py-[6vw] flex md:flex-row flex-col items-center gap-2'>
      <div className='md:w-[45%] w-full flex flex-col gap-4'>
        <div className='md:text-[4.5rem] tracking-tight text-[4rem] md:leading-[6vw] leading-[19vw] font-semibold text-darkblue'>{data?.heading.slice(0, 12)}<br /><span className='bg-darkblue text-white rounded-full px-4 shrink-0 md:text-[4rem] text-[3rem]'><ServiceWriter /></span>
